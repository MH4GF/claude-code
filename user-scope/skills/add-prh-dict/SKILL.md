...
`/Users/mh4gf/ghq/github.com/MH4GF/claude-code/prh.yml` に prh ルールを追加し、unslop で構文確認した上で commit して push する。完了したら tq action done を呼ぶ。
...
5. `unslop -c .textlintrc.json --no-color prh.yml` で構文確認する (exit 0)
6. `git add prh.yml`
